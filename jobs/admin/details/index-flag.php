                        ...
                        <div class="form-flag-field">
                            <div class="flag-field">
                                <!-- <img src="<?php // echo $dir; ?>/assets/images/america-flag.png" alt="">
                                 <input id="country" type="tel" value="+1" readonly="" placeholder="+1"> -->
                            </div>
                            <input type="tel" name="phone" id="country">
                        </div>
                    </div>
                </div>
                <div class="form-box flex align-vert edge middle gap-5 usa-option">
...
<!-- 
    <form>
      <input id="country" name="phone" type="tel" />
      <button type="submit">Submit</button>
      <div class="usa-option" style=" color: black; font-size: 50px;">
        <div class="onlyusa">
            <h1 class="onlyusa">This is testing</h1>
        </div>
      </div>
    </form> -->
...
<script>
    ...
    //     // let appendInfo = "<div class='onlyusa'>This is Testing</div>"
    ...
    let cnty = iti.getSelectedCountryData();
    // if(cnty.dialCode == '1') {

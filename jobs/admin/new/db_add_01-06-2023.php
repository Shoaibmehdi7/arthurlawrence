...
)
{
    ...
    // die();
     ...
     $sql= "INSERT INTO `new_user` (`title`, `job_code`, `description`, `city`, `state`, `remote_job`, `skills`, `duration`, `type`, `fk_category`, `pay`, `ending_date`, `authorization`, `job_post_date`, `travel_required`, `active`) VALUES ('$title', '$job_code', '$description', '$city', '$state', '$remote_job', '$skills', '$duration', '$type', '$fk_category', '$pay', '$ending_date', '$authorization', '$job_post_date', '$travel_required', '$active')";

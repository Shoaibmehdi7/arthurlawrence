	 ...
	 <div class="container-fluid">
	 	<div  class="row">
	 	 <div class="container-block"  style="float: left;width: 100%;">
	 	 	<section id="banner" style="background-image: url('img/bannerkpo-12.png');  
">
    <div class="bnr-cont">
        <div class="container gw">
            <h1  class="headingslide" style="color:rgb(46, 46, 46)">The legal process <br>landscape</h1>
            <p class="sliderP" style="color:rgb(46, 46, 46)">Creating new capacities within the services ecosystem <br> with Legal Process Outsourcing (LPO) expertise.</p>
        </div>
    </div>
</section>
	 	 </div>
...
<br><br>We evaluate the current challenges facing the corporate legal departments of an organization across their people, process and technology and provide viable solutions that meet the business’ needs. 
<br><br>A corporate legal process outsourcing solution adapts to the changing service delivery needs for each organization. We help our clients develop a flexible, scalable and efficient delivery model to enhance the value of the enterprise and simultaneously cutting costs for growth. 
<br><br>
...
<div class="row ">
	...
	<div class="col-sm-4">
		...
		<div class="box-txt-head">Powered by technology</div>
	...
	<div class="col-sm-4">
		<div class="box-container">
		<div class="box-txt-head">Centered on security</div>
		<div class="box-txt-desc">
	...
	<div class="col-sm-4">
		<div class="box-container">
		<div class="box-txt-head">Comprehensive offering</div>
		<div class="box-txt-desc">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="col-md-12  row">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12 small-text" style="margin-left: -5px;     left: 20px;">
                                <h4 style="font-family: 'Montserrat', sans-serif !important; letter-spacing: 0px !important;font-weight: lighter;margin-top: 5px;    margin-top: 3em;">Let’s help you augment your legal capacity.
